...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="min-h-screen  bg-gray-100">
            <nav className=" bg-[#1E293B] border-b border-[#1E293B]">
                    ...
                    <div className="flex justify-between h-16">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200 [#1E293B] hover:text-gray-300 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {auth.user.firstName}
                        ...
                        <div className="-mr-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center p-2 rounded-md text-gray-100 hover:text-gray-100 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out"
                            >
